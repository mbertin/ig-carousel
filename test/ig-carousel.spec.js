describe('Test ig-carousel directive', function() {
    ...
    beforeEach(inject(function($rootScope, $compile) {
        elm = angular.element('<div> <ul ig-carousel animation-duration="800" auto-slide="true" rtl="true" slide-duration="5" item-displayed="5" ><li>First item</li><li>Second item</li><li>Third item</li><li>Fourth item</li><li>Fifth item</li><li>Sixth item</li><li>Seventh item</li></ul></div>');
